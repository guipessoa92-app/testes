<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ 'Adicionar Exercício ao Treino de ' . $aluno->name }}
        </h2>
    </x-slot>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <h3 class="text-lg font-medium text-gray-900 mb-4">Adicionar exercício ao treino: {{ $training->name }}</h3>
                    <form action="{{ route('personal.students.exercises.store', ['aluno' => $aluno, 'training' => $training]) }}" method="POST">
                        @csrf
                        <div>
