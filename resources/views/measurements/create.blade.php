        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <h3 class="text-lg font-medium text-gray-900 mb-4">Registrar Novas Medidas</h3>
                    <form action="{{ route('measurements.store') }}" method="POST">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <x-text-input id="measurement_date" class="block mt-1 w-full" type="date" name="measurement_date" :value="old('measurement_date')" required autofocus />
                                <x-input-error class="mt-2" :messages="$errors->get('measurement_date')" />
                            </div>
                            <div>
                                <x-input-label for="weight" :value="__('Peso (kg)')" />
                                <x-text-input id="weight" class="block mt-1 w-full" type="number" step="0.01" name="weight" :value="old('weight')" max="999.99" />
                        ...
                        <div class="mt-4">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                <div>
                                    ...
                                    <x-text-input id="shoulders" class="block mt-1 w-full" type="number" step="0.01" name="shoulders" :value="old('shoulders')" max="999.99" />
                                </div>
                                <div>
                                    <x-input-label for="chest" :value="__('Peito')" />
                                    <x-text-input id="chest" class="block mt-1 w-full" type="number" step="0.01" name="chest" :value="old('chest')" max="999.99" />
                                </div>
                                <div>
                                    <x-input-label for="waist" :value="__('Cintura')" />
                                    <x-text-input id="waist" class="block mt-1 w-full" type="number" step="0.01" name="waist" :value="old('waist')" max="999.99" />
                                </div>
                                <div>
                                    <x-input-label for="abdomen" :value="__('Abdômen')" />
                                    <x-text-input id="abdomen" class="block mt-1 w-full" type="number" step="0.01" name="abdomen" :value="old('abdomen')" max="999.99" />
                                </div>
                                <div>
                                    <x-input-label for="hips" :value="__('Quadril')" />
                                    <x-text-input id="hips" class="block mt-1 w-full" type="number" step="0.01" name="hips" :value="old('hips')" max="999.99" />
                                </div>
                                <div>
                                    <x-input-label for="gluteos" :value="__('Glúteos')" />
                                    <x-text-input id="gluteos" class="block mt-1 w-full" type="number" step="0.01" name="gluteos" :value="old('gluteos')" max="999.99" />
                                </div>
                            </div>
                        </div>
                                ...
                                <fieldset class="border p-4 rounded-md">
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-2">
                                        <div>
                                            ...
                                            <x-text-input id="biceps_right_contracted" class="block mt-1 w-full" type="number" step="0.01" name="biceps_right_contracted" :value="old('biceps_right_contracted')" max="999.99" />
                                        </div>
                                        <div>
                                            <x-input-label for="biceps_right_relaxed" :value="__('Relaxado')" />
                                            <x-text-input id="biceps_right_relaxed" class="block mt-1 w-full" type="number" step="0.01" name="biceps_right_relaxed" :value="old('biceps_right_relaxed')" max="999.99" />
                                        </div>
                                    </div>
                                </fieldset>
                                <fieldset class="border p-4 rounded-md">
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-2">
                                        <div>
                                            ...
                                            <x-text-input id="biceps_left_contracted" class="block mt-1 w-full" type="number" step="0.01" name="biceps_left_contracted" :value="old('biceps_left_contracted')" max="999.99" />
                                        </div>
                                        <div>
                                            <x-input-label for="biceps_left_relaxed" :value="__('Relaxado')" />
                                            <x-text-input id="biceps_left_relaxed" class="block mt-1 w-full" type="number" step="0.01" name="biceps_left_relaxed" :value="old('biceps_left_relaxed')" max="999.99" />
                                        </div>
                                    </div>
                                </fieldset>
                                <fieldset class="border p-4 rounded-md">
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-2">
                                        <div>
                                            ...
                                            <x-text-input id="forearm_right" class="block mt-1 w-full" type="number" step="0.01" name="forearm_right" :value="old('forearm_right')" max="999.99" />
                                        </div>
                                        <div>
                                            <x-input-label for="forearm_left" :value="__('Esquerdo')" />
                                            <x-text-input id="forearm_left" class="block mt-1 w-full" type="number" step="0.01" name="forearm_left" :value="old('forearm_left')" max="999.99" />
                                        </div>
                                    </div>
                                </fieldset>
                            </div>
                                ...
                                <fieldset class="border p-4 rounded-md">
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-2">
                                        <div>
                                            ...
                                            <x-text-input id="thigh_right" class="block mt-1 w-full" type="number" step="0.01" name="thigh_right" :value="old('thigh_right')" max="999.99" />
                                        </div>
                                        <div>
                                            <x-input-label for="thigh_left" :value="__('Esquerda')" />
                                            <x-text-input id="thigh_left" class="block mt-1 w-full" type="number" step="0.01" name="thigh_left" :value="old('thigh_left')" max="999.99" />
                                        </div>
                                    </div>
                                </fieldset>
                                <fieldset class="border p-4 rounded-md">
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-2">
                                        <div>
                                            ...
                                            <x-text-input id="calf_right" class="block mt-1 w-full" type="number" step="0.01" name="calf_right" :value="old('calf_right')" max="999.99" />
                                        </div>
                                        <div>
                                            <x-input-label for="calf_left" :value="__('Esquerda')" />
                                            <x-text-input id="calf_left" class="block mt-1 w-full" type="number" step="0.01" name="calf_left" :value="old('calf_left')" max="999.99" />
                                        </div>
                                    </div>
                                </fieldset>
                            </div>
                            ...
                            <div x-show="open" x-collapse>
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <x-text-input id="age" class="block mt-1 w-full" type="number" name="age" :value="old('age')" max="200" />
                                    ...
                                    <div>
                                        ...
                                        <x-text-input id="pectorals" class="block mt-1 w-full" type="number" step="0.01" name="pectorals" :value="old('pectorals')" max="999.99" />
                                        <x-input-error class="mt-2" :messages="$errors->get('pectorals')" />
                                    </div>
                                    <div>
                                        <x-input-label for="midaxillary" :value="__('Axilar Média (mm)')" />
                                        <x-text-input id="midaxillary" class="block mt-1 w-full" type="number" step="0.01" name="midaxillary" :value="old('midaxillary')" max="999.99" />
                                        <x-input-error class="mt-2" :messages="$errors->get('midaxillary')" />
                                    </div>
                                    <div>
                                        <x-input-label for="triceps" :value="__('Tricipital (mm)')" />
                                        <x-text-input id="triceps" class="block mt-1 w-full" type="number" step="0.01" name="triceps" :value="old('triceps')" max="999.99" />
                                        <x-input-error class="mt-2" :messages="$errors->get('triceps')" />
                                    </div>
                                    <div>
                                        <x-input-label for="subscapular" :value="__('Subescapular (mm)')" />
                                        <x-text-input id="subscapular" class="block mt-1 w-full" type="number" step="0.01" name="subscapular" :value="old('subscapular')" max="999.99" />
                                        <x-input-error class="mt-2" :messages="$errors->get('subscapular')" />
                                    </div>
                                    <div>
                                        <x-input-label for="abdominal" :value="__('Abdominal (mm)')" />
                                        <x-text-input id="abdominal" class="block mt-1 w-full" type="number" step="0.01" name="abdominal" :value="old('abdominal')" max="999.99" />
                                        <x-input-error class="mt-2" :messages="$errors->get('abdominal')" />
                                    </div>
                                    <div>
                                        <x-input-label for="suprailiac" :value="__('Supra-ilíaca (mm)')" />
                                        <x-text-input id="suprailiac" class="block mt-1 w-full" type="number" step="0.01" name="suprailiac" :value="old('suprailiac')" max="999.99" />
                                        <x-input-error class="mt-2" :messages="$errors->get('suprailiac')" />
                                    </div>
                                    <div>
                                        <x-input-label for="skinfold_thigh_right" :value="__('Coxa Direita (mm)')" />
                                        <x-text-input id="skinfold_thigh_right" class="block mt-1 w-full" type="number" step="0.01" name="skinfold_thigh_right" :value="old('skinfold_thigh_right')" max="999.99" />
                                    ...
                                    <div>
                                        ...
                                        <x-text-input id="skinfold_thigh_left" class="block mt-1 w-full" type="number" step="0.01" name="skinfold_thigh_left" :value="old('skinfold_thigh_left')" max="999.99" />
